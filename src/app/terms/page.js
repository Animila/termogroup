export default function Terms() {
    return (
        <div className="pt-[120px] md:px-[100px] flex flex-col md:gap-[20px]">
                ...
                <details>
                        ...
                        обработки персональных данных и меры по обеспечению безопасности персональных данных ТОО
                        "ТЕРМО ГРУПП" (далее – Оператор).</p>
