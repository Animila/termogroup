...
const EndPageCalculate = ({setStep, register, watch, setValue}) => {
  ...
  return <div className="mt-[50px] flex flex-col gap-[20px] relative h-full">
    <div className="text-white md:text-[35px] leading-[24px] font-bold">Как вам удобнее получить расчет и скидку?</div>
    <div className="md:w-[650px]">
      ...
      <div className="mt-[30px]">
        ...
        <div className="flex border-gray border-[1px]">
          ...
          <InputMask id={"phone"} placeholder="Введите свой номер телефона" {...register('phone')} className="w-full bg-transparent text-white text-[17px] outline-0" mask="+7(999)999-99-99" maskChar=" " />;
        </div>
      </div>
      <div className="mt-[200px] flex md:flex-row sm:flex-col items-center gap-[30px]">
        <button disabled={!active} className={`flex ${active ? 'bg-main_one text-white' : 'bg-gray text-accent_one'} justify-center items-center w-[358px] h-[60px] rounded-[100px]  gap-[10px]`}>
